...
export function Footer() {
  ...
  return (
    <footer className="footer-premium relative overflow-hidden text-white">
      ...
      <div className="relative container-wide py-10 lg:py-11">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1fr_1.2fr] lg:gap-10">
          <section className="max-w-sm">
            ...
            <p className="mt-4 max-w-[19rem] text-sm leading-6 text-white/65" data-cms-field="footer.tagline">{t("footer.tagline")}</p>
            <a
